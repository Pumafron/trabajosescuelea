...
public class FrameMenu extends javax.swing.JFrame {
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        // TODO add your handling code here:
        /*
        var internalFrame = new JInternalFrame("Internal Frame", true, true, true, true);
        internalFrame.setPreferredSize(new Dimension(400, 300));
        internalFrame.setMaximumSize(new Dimension(400, 300));
        internalFrame.setMinimumSize(new Dimension(400, 300));
